package com.scframework.smartcloudgateway.redis.util;
...
public class RedisUtil {
    ...
    public boolean set(String key, Object value) {
        try {
            ...
            e.printStackTrace();
            log.error("redis set[key, val] error: {}", e.getMessage());
            return false;
        }
    ...
    public boolean set(String key, Object value, long time) {
        try {
            ...
            e.printStackTrace();
            log.error("redis set[key, value, time] error: {}", e.getMessage());
            return false;
        }
    }
    ...
    public List<Object> lGet(String key, long start, long end) {
        try {
            ...
            e.printStackTrace();
            log.error("redis lGet error: {}", e.getMessage());
            return null;
        }
    }
    ...
    public long lGetListSize(String key) {
        try {
            ...
            e.printStackTrace();
            log.error("redis lGetListSize error: {}", e.getMessage());
            return 0;
        }
    }
     ...
     *
     * @param key 键
     * @param index 索引index>=0时， 0表头，1第二个元素，依次类推；index<0时，-1，表尾，-2倒数第二个元素，依次类推
     * @return Object
     */
    public Object lGetIndex(String key, long index) {
        try {
            ...
            e.printStackTrace();
            log.error("redis lGetIndex error: {}", e.getMessage());
            return null;
        }
    }
    ...
    public boolean lSet(String key, Object value) {
        try {
            ...
            e.printStackTrace();
            log.error("redis lSet[key, val] error: {}", e.getMessage());
            return false;
        }
    }
    ...
    public boolean lSet(String key, Object value, long time) {
        try {
            ...
            e.printStackTrace();
            log.error("redis lSet[key, val, time] error: {}", e.getMessage());
            return false;
        }
    }
    ...
    public boolean lUpdateIndex(String key, long index, Object value) {
        try {
            ...
            e.printStackTrace();
            log.error("redis lSet[key, index, val] error: {}", e.getMessage());
            return false;
        }
    }
    ...
    public long lRemove(String key, long count, Object value) {
        try {
            ...
            e.printStackTrace();
            log.error("redis lSet[key, count, val] error: {}", e.getMessage());
            return 0;
        }
    }
